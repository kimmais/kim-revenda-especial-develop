...
import {addCardTypeOperator,addResellerList,getState,getCardTypeOperatorAndValues,getResellerBill,getResellerEquipment,getCardTypeOperatorAndParameters,getDisabledClass,goBack,hasFormValueChanged,inativeEquipment,isFormInvalid,authorizedResale,editResellerList,notAuthorizedResale,removeCardTypeOperator,saveEdit,updateUser,updateCardTypeOperator,_putApiReseller,toggleModal} from "./ResellerController";

declare interface ObjectConstructor {
  assign(...objects: Object[]): Object;
}

const ResellerEdit: React.FC = () => {
  ...
  const [formState, setFormState]: any = useState({
    ...
    typeReseller: { error: "", value: String(typeReseller) },
    limitReseller: { error: "", value: limitReseller.toFixed(2) },
    ...
    resellerTypeSelected: { error: "", value: !isSpecial ? "1":"2" },
    isSuspendedResaleSelected: { error: "", value: !isSuspendedResale ? "1":"2" },
    isSuspendedResale: {
      error: "",
      value: [
        { id: 1, name: "Ativo" },
  ...
  useEffect(() => {
    ...
    getCardTypeOperatorAndValues(dispatch,setFormState,isAuthorizedResale,token,id);
        ...
        <div className="">
          <div className="card shadow mb-4">
            ...
            <div className="card-body">
              <form onSubmit={(form)=>updateUser(dispatch,setLoader,setModal,formState,isFormInvalid,history,isAuthorizedResale,token,id,form)}>
                ...
                {!isAuthorizedResale ? (
                  <>
                    ...
                    <button
                      ...
                      onClick={()=>notAuthorizedResale(dispatch,setFormState,formState)}
                    >
                      Recusar
                    </button>
                    <button
                  ...
                  <>
                    ...
                    <button
                      type="button"
                      className={`btn btn-success left-margin ${getDisabledClass(formState)}`}
                      onClick={()=>saveEdit(dispatch,isFormInvalid,formState)}
                    >
                      Salvar
                    </button>
                  </>
